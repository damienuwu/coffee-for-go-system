    ...
    if ($row == 0) {
        ...
        <body>
            ...
            <div class="rounded-square1">
                ...
                <p class="text1">Pickup</p>
                <a href="cartDeliver.php" class="noline">
                    <p class="text22">Switch To Delivery</p>
                </a>
                ...
                } elseif ($selectedValue === 'option4') {
                    $branch = 'A Lot G.15 & G.16. KL Gateway Mall. 2, Jalan Kerinchi, Kampung Kerinchi, 59200 Kuala Lumpur, Wilayah Persekutuan Kuala Lumpur.';
                } elseif ($selectedValue === 'option5') {
                    $branch = 'Lot F37. Jalan R1, Seksyen 1, Bandar Baru Wangsa Maju 53300 Kuala Lumpur.';
                } elseif ($selectedValue === 'option6') {
                    $branch = 'Lot CPD 3 A06, Gate A, Contact Pier Domestic KLIA, Kuala Lumpur International Airport, 64000 Sepang, Selangor Darul Ehsan.';
                } elseif ($selectedValue === 'option7') {
                    $branch = 'Lot KF2. Jalan Jejaka, Maluri, 55100 Cheras, Wilayah Persekutuan Kuala Lumpur';
                } elseif ($selectedValue === 'option8') {
